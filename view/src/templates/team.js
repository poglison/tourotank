    ...
    return (
        <div className="mt-10">
            ...
            <div className="flex flex-col xl:flex-row xl:flex-wrap mt-4">
                ...
                {props.type == "new" &&
                    <div onClick={() => props.setTeam([...props.team, { name: "Nome", rule: "CARGO" }])} className="mt-4 h-48 xl:w-[calc(33%-8px)] mb-4 xl:mb-0 w-full border-[1.5px]   rounded-lg p-4 flex flex-col items-center justify-center hover:bg-zinc-50 text-zinc-500 cursor-pointer">
