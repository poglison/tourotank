                ...
                <div className="w-full h-full ml-6 flex flex-col justify-center">
                    ...
                    {props.type == "new" ?
                        <div className="flex items-center">
                            <input className="text-stone-700 text-xl font-medium outline-none placeholder:font-normal" placeholder="Digite o nome do CEO" />
                            <span className="text-primary text-sm font-bold ml-4">CEO</span>
                        </div>
                        :
                        <div className="flex items-center">
                            <span className="text-stone-700 text-xl font-medium">Alan Hui</span>
                            <span className="text-primary text-sm font-bold ml-4">CEO</span>
                        </div>
                    }
                            ...
                            <div className="w-full flex items-center justify-between mb-2">
                                {props.type == "new" ?
                                    <div className="w-full h-4 flex">
                                        <input className="text-stone-700 text-base font-normal w-1/2 outline-none" placeholder={person.displayName} />
                                        <input className="text-stone-400 text-sm font-normal w-1/2 ml-4 outline-none text-end" placeholder={person.rule} />
                                    </div>
                                    :
                                    <div className="w-full h-4 flex justify-between">
                                        <span className="text-stone-700 text-base font-medium">{person.displayName}</span>
                                        <span className="text-stone-400 text-sm font-bold ml-4">{person.rule}</span>
                                    </div>
                                }
                            </div>
                            <div className="bg-stone-300 w-28 min-w-28 h-28 min-h-28 rounded-full" />
                        </div>
                    )
                })
                }
