    ...
    return (
        <div className={"bg-white border-[1.5px] rounded-full z-10 w-full flex items-center px-5 " + props.className}>
            ...
            {(props.type === "password" && !visible) ?
                <svg onClick={() => setVisible(!visible)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="relative -mr-4 ml-4 text-stone-400 hover:bg-stone-100 w-10 min-w-10 h-10 p-2.5 rounded-full">
