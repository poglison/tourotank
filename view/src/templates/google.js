...
export default function Login() {
    ...
    return <button className="" onClick={handleLoginFromGoogle}>
        <div className="cursor-pointer border-[1.5px] dark:border-stone-800 rounded-lg h-14 w-14 flex items-center justify-center mr-4 hover:bg-stone-50 dark:hover:bg-stone-900">
