            ...
            {open &&
                <div className="mt-72 mr-40 absolute w-52 min-h-52 border-[1.5px] bg-white border-zinc-300 rounded-xl">
                    ...
                    <div className="font-ibm">
                        <div className="relative w-full h-12 p-3 border-b-[1.5px] border-zinc-300 hover:bg-zinc-50 flex items-center px-4 cursor-pointer">
                        ...
                        <div className="w-full h-12 p-3 border-b-[1.5px] border-zinc-300 hover:bg-zinc-50 flex items-center px-4 cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-zinc-600">
