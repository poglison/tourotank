...
export default function Categories() {
    ...
    return (
        <div className="relative flex items-center justify-center mr-4">
            <div onClick={() => { setOpen(!open) }} className="h-full flex items-center justify-center text-stone-500 dark:text-stone-400 hover:dark:text-stone-100 px-2 cursor-pointer">
                ...
                <div className="overflow-auto h-[calc(100%-120px)] left-5 md:left-10 top-20 mr-40 fixed w-[calc(100%-40px)] md:w-[calc(100%-80px)] border border-stone-300 dark:border-stone-700 bg-white dark:bg-stone-850 rounded-xl">
                    ...
                    <div className="font-ibm flex flex-wrap pb-6 pt-6 items-center justify-center">
                        {others.map((other, index) => {
                            return (
                                <Link key={index} to={"/category/" + other.value} className="w-full mx-4 md:mx-0 md:w-72 relative h-14 p-3 hover:bg-stone-50 border border-transparent dark:hover:border-stone-700 hover:border-stone-300 dark:hover:bg-stone-900 flex items-center px-4 cursor-pointer rounded-lg">
                    ...
                    <div className="font-ibm flex flex-wrap pb-6 pt-6 items-center justify-center">
                        ...
                        {games.map((game, index) => {
                            return (
                                <Link key={index} to={"/category/" + game.value} className="w-full mx-4 md:mx-0 md:w-72 relative h-14 p-3 hover:bg-stone-50 border border-transparent dark:hover:border-stone-700 hover:border-stone-300 dark:hover:bg-stone-900 flex items-center px-4 cursor-pointer rounded-lg">
