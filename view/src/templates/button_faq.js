...
export default function ButtonFAQ() {
    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-center p-2 mt-8 w-full h-24 border dark:border-stone-700  rounded-lg hover:bg-stone-50 dark:hover:bg-stone-900 cursor-pointer">
