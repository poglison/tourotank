    ...
    return (
        <div className={"w-full mt-10 " + (props.className)}>
            ...
            <div className="mt-5">
                ...
                {faq?.map((item, index) => (
                    <div key={index} className="rounded-xl bg-stone-100 dark:bg-stone-900  mb-2 md:mr-6 hover:bg-stone-200 hover:dark:bg-stone-800" onClick={() => { setFaq(faq.map((item, i) => { if (i == index) { item.click = !item.click } return item })) }}>
