      ...
      <div className="flex items-center justify-between">
        ...
        {props.buttons != false &&
          <>
            ...
            {props.search &&
              <div className="hidden md:flex items-center justify-between mr-4  rounded-lg bg-white dark:bg-stone-900 border border-stone-300 dark:border-stone-700 h-11 px-4 pl-3">
