...
export default function Banner() {
    ...
    return (
        <div className="w-full px-5 md:px-10 overflow-hidden h-96 pr-20 md:pr-10 pt-20 font-montserrat relative">
            ...
            <div className="w-3/4 h-full flex flex-col justify-center xl:items-center">
                ...
                <div className="flex items-center flex-col md:flex-row">
                    ...
                    <h1 className={"hidden md:flex ml-4 text-5xl md:text-8xl font-bold text-primary z-10 relative transition-all " + (select == "comprar" ? "rotate-30" : "")}>👉</h1>
