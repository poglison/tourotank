        ...
        <div className={"z-10 relative transition-all select-none " + props.className}>
            ...
            {props.hub !== false &&
                <div className="w-full flex flex-col md:flex-row justify-center items-center mt-5">
                    ...
                    <Link to="/hub">
                        <div className="flex p-3 rounded-full   ease-in-out cursor-pointer font-ibm font-medium text-stone-800 hover:text-black dark:text-stone-200 dark:hover:text-stone-50 hover:underline hover:decoration-wavy decoration-primary">
