        ...
        <div className={"p-10 z-10 relative transition-all select-none " + props.className}>
            ...
            {props.hub !== false &&
                <div className="w-full flex flex-col md:flex-row justify-center items-center mt-5">
                    <span className="text-lg text-zinc-700 font-ibm mr-1 text-center">Para ver mais projetos, você pode entrar no nosso</span>

                    <Link to="/hub">
                        <div className="flex p-3 rounded-full border-white border-[1.5px] ease-in-out cursor-pointer font-ibm font-medium transition-all text-zinc-800 hover:text-black hover:underline hover:decoration-wavy decoration-primary">
