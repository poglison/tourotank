...
export default function Login() {
    ...
    return (
        <div className="relative md:h-screen md:overflow-hidden bg-white dark:bg-stone-850">
                ...
                <div className="w-full md:w-1/2 flex justify-center items-center">
                    ...
                    <div className="w-full xl:w-3/4 z-10 p-10">
                        ...
                        <div className="w-full mt-2 flex items-center justify-center">
                            <span className="text-sm text-stone-500">Já tem uma conta?</span>
                        ...
                        <div className="flex items-center justify-center mt-8 w-full h-10">
                            ...
                            <Link to="/">
                                <div className="cursor-pointer border dark:border-stone-700 dark:bg-stone-900 rounded-lg h-14 w-14 flex items-center justify-center mr-4 hover:bg-stone-50 dark:hover:bg-stone-900">
