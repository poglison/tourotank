                        ...
                        <div className="bottom-6 fixed flex w-11/12 md:w-1/2 h-20 items-center justify-between p-5 z-10 px-0 ">
                            ...
                            <div className="bg-white border rounded-full z-10 w-full flex items-center px-5 pr-1.5">
                                ...
                                {completedTyping ?
                                    ...
                                    :
                                    <button className="ml-5 flex items-center bg-stone-400 text-white border border-stone-400 rounded-full w-10 h-10 min-h-10 min-w-10 justify-center cursor-pointer hover:bg-primary-600">
