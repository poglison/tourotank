        ...
        <div className="relative md:h-screen md:overflow-hidden">
            ...
            <div className="top-0 absolute flex w-full md:h-screen mt-40 md:mt-0">
                ...
                <div className="hidden md:flex flex-col h-screen justify-between items-center w-1/2 bg-primary text-white font-ibm relative">
                    ...
                    <img className="max-h-[1000px] h-2/3 hidden xl:flex absolute -bottom-40 -right-44 select-none -rotate-12" src="/bull.png" alt="" />
                    ...
                    <div className="w-full mt-10 p-10 z-20">
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <div className="flex space-x-2 mt-2">
                                <Link to="/sobre">
                                    <span className="text-zinc-50 text-xs hover:underline">Termos de uso</span>
                                </Link>

                                <Link to="/sobre">
                                    <span className="text-zinc-50 text-xs hover:underline">Politica de privacidade</span>
                                </Link>

                                <Link to="/sobre">
                                    <span className="text-zinc-50 text-xs hover:underline">Política de Cookies</span>
                                </Link>
