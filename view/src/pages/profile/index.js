...
export default function Profile() {
    ...
    return (
        <div className='overflow-x-hidden relative'>
            ...
            <div className='w-full pt-20 absolute top-0 h-64 bg-zinc-50 rounded border-b'>
                    ...
                    <div className='flex items-center'>
                        ...
                        <div>
                            <div className='flex items-center'>
                                ...
                                {/* <div className='w-24 h-6 ml-4 border-[1.5px] font-medium border-zinc-400 rounded-full text-xs flex items-center justify-center cursor-pointer hover:bg-zinc-600 text-zinc-600 hover:text-white'>
                                        Editar perfil
                                    </div> */}
                            </div>
            ...
            <Container className='pt-0'>
                ...
                <div className='mt-52 flex flex-col md:flex-row'>
                    <div className='flex flex-col w-full md:flex-col md:!w-60 border-[1.5px]   rounded-lg'>
                        ...
                        <span className='block px-4 pt-4 pb-4 mb-0 font-medium text-zinc-700 border-b-[1.5px]'>Menu</span>
                                    ...
                                    if (items.length - 1 == index) {
                                        return (
                                            <div key={index} className='w-full h-12 p-2 px-4 hover:bg-zinc-50 rounded-b-lg flex items-center cursor-pointer'>
                                                ...
                                                <span className="text-sm ml-3 text-zinc-600">{item.title}</span>
                                            </div>
                                        )
                                    } else {
                                        return (
                                            <div key={index} className='w-full h-12 p-2 px-4 border-b-[1.5px] hover:bg-zinc-50 flex items-center cursor-pointer'>
