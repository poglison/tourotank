...
export default function Banner() {
    ...
    return (
        <div className="p-5 md:p-10 pr-20 md:pr-10 pt-20 font-montserrat">

            <p className="text-lg md:text-5xl font-bold text-zinc-700 z-10 relative">uma nova maneira de</p>
