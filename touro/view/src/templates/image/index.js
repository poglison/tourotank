                        ...
                        <div className="relative w-3/5 my-6 mx-auto">
                            ...
                            <div className="border-0 relative flex flex-col w-full outline-none focus:outline-none">
                                ...
                                <div className="p-5 px-8 fixed top-0 right-0 flex items-start justify-end pb-0 rounded-t">
                                    ...
                                    {/* <button
                                        className="p-2 bg-white rounded ml-2 border-0 text-zinc-700 hover:text-zinc-900 hover:bg-zinc-300 text-3xl leading-none font-semibold outline-none focus:outline-none"
                                    ...
                                    <button
                                        className="p-2 bg-white rounded ml-2 mr-2 border-0 text-zinc-700 hover:text-zinc-900 hover:bg-zinc-300 text-3xl leading-none font-semibold outline-none focus:outline-none"
