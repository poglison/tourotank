...
const TimeLineCircle = (props) => {
    return (
        <div className={"flex flex-col items-center justify-center border w-full h-28 rounded " + (props.check ? "border-primary bg-primary/5" : "border-zinc-300")}>
            <div className={"flex items-center justify-center w-10 h-10 rounded-full " + (props.check ? "bg-primary" : "bg-zinc-300")}>
...
const TimelineItem = (props) => {
    return (
        <div className="flex flex-row items-center">
            <div className={"h-px w-16 md:w-28 " + (props.check ? "bg-primary" : "bg-zinc-300")}></div>
        </div>
    )
}