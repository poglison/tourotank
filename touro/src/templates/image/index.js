...
export default function Image(props) {
    ...
    return (
        <div>
            <img onClick={() => { setIsModalVisible(true) }} src={props.src} alt={props.alt} className={"rounded-2xl cursor-pointer " + props.className} />
                        ...
                        <div className="relative w-4/5 my-6 mx-auto">
                            ...
                            <div className="border-0 relative flex flex-col w-full outline-none focus:outline-none">
                                ...
                                <div className="flex items-start justify-end p-3 pb-0 px-4 rounded-t">
                                    ...
                                    <button
                                        className="p-2 bg-white ml-2 border-0 text-black text-3xl leading-none font-semibold outline-none focus:outline-none"
                                    ...
                                    <button
                                        className="p-2 bg-white ml-2 mr-2 border-0 text-black text-3xl leading-none font-semibold outline-none focus:outline-none"
