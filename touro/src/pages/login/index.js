        ...
        <div className="relative">
            ...
            <div className="top-0 absolute flex w-full h-screen">
                <div className="w-1/2 flex justify-center items-center">
                    ...
                    <div className="w-2/3 z-10 p-6">
                        ...
                        <div className="mb-10 mt-2 flex items-center justify-center">
                            ...
                            <span className="font-ibm text-xl font-medium text-primary">Entre agora</span>
                ...
                <div className="flex flex-col h-screen justify-between items-center w-1/2 bg-primary text-white font-ibm relative">
                    <img src="https://images.ctfassets.net/hrltx12pl8hq/5KiKmVEsCQPMNrbOE6w0Ot/341c573752bf35cb969e21fcd279d3f9/hero-img_copy.jpg?fit=fill&w=1200&h=630" className="absolute top-0 rigth-0 h-screen object-cover grayscale opacity-20" />
                    ...
                    <div className="h-full flex flex-col items-center justify-center z-20">
                        ...
                        <div className="mt-6 flex items-center justify-center">
                            ...
                            <span className="text-sm text-white underline cursor-pointer hover:font-medium hover:decoration-2">entre em contato</span>
                        </div>
                    </div>
